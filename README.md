...
Результаты последнего прогона — [`LOAD.md`](LOAD.md).
...
Обоснование выбора с расчётами и трейд-оффами — [`ARCHITECTURE.md`](ARCHITECTURE.md).
...
[`AI.md`](AI.md) — как проектировалось, включая шесть мест, где решение
