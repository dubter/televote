...
// majorVersionAfter достаёт мажорную версию: минорные и патч-версии
// дробили бы классы на сотни значений и вернули бы отпечаток через заднюю дверь.
