...
func servePage(body []byte) http.HandlerFunc {
	return func(w http.ResponseWriter, _ *http.Request) {
		...
		_, _ = w.Write(body) //nolint:errcheck // a dropped connection while serving the page is the client's business
	}
}
...
func qrHandler(baseURL string) http.HandlerFunc {
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = w.Write(png) //nolint:errcheck,gosec // the PNG is generated by us, XSS is not possible
	}
}
